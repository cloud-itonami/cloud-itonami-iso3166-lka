...
`cloud-itonami-iso3166-lka` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Sri Lankan-licensed counsel or a registered agent for whatever licensed
representation the law of Sri Lanka requires for public-procurement
filings.
