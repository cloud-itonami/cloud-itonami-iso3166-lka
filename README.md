...
Open ISO 3166 Blueprint for **LKA**: Sri Lanka.
...
tax registration, and local-content rules in Sri Lanka, so the operator
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Sri Lankan-licensed counsel
...
(ISO 3166 `LKA`). Required capabilities:
