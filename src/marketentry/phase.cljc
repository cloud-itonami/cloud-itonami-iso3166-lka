(ns marketentry.phase
  "Phase 0->3 staged rollout for the Democratic Socialist Republic of
  Sri Lanka (LKA) market-entry compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no bid/BOI
                                 registration risk yet) may auto-commit.
  ...
  real bid/tender-response (or BOI investment-registration application)
  package and submitting a real filing are the two real-world acts this
  actor performs; both are always a human market-entry operator's call.
